...
{
    [CustomPropertyDrawer(typeof(ComboBox.OptionDataList), true)]
    /// <summary>
    ///   This is a PropertyDrawer for ComboBox.OptionDataList it is implemented using the standard unity PropertyDrawer framework.
    /// </summary>
    class ComboBoxOptionListDrawer : PropertyDrawer
    {
